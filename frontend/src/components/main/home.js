...
<<<<<<< HEAD
    <div>
      <div
        data-draggable="true"
        className=""
        style={{ position: "relative", draggable: "false" }}
      >
        <section
          draggable="false"
        ...
        >
          <section className="mb-10">
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://images.pexels.com/photos/57705/lake-evening-sunset-abendstimmung-57705.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)",
                height: "500px",
                    ...
                    <div className="col-lg-8">
                      <div className="text-white">
                        <h2 className="mb-4 px-4 px-md-5 display-3 fw-bold ls-tight">
                          ...
                          <span className="">for the shoot?</span>{" "}
                        </h2>
                        <p className="text-white lead mb-0 px-4 px-md-5">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Minima officia consequatur adipisci tenetur
        ...
        >
          <section className="mb-10">
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://media.architecturaldigest.com/photos/5b7dc0c5f3a08c0bc142f98f/master/pass/GettyImages-617579982.jpg)",
                height: " 500px",
                backgroundSize: "cover",
                backgroundPosition: "50% 50%",
                backgroundColor: "rgba(0, 0, 0, 0)",
...
>>>>>>> cb4218821ede72fb0f5742fe8b44461b3cdf4d7f
...
<<<<<<< HEAD
                        ...
                        <a
                          className="btn   btn-secondary btn-lg py-3 px-5 me-2"
                          href="#!"
                          role="button"
      ...
      <div data-draggable="true" className="" style={{ position: "relative" }}>
        ...
        >
          <section className="mb-10 text-center">
            <h2 className="fw-bold mb-7 text-center">
