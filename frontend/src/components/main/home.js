...
<<<<<<< HEAD
    <div >
      ...
      <div data-draggable="true" className="" style={{ position: 'relative', draggable: 'false' }}>
        ...
        <section draggable="false" className="container-fluid pt-2" data-v-271253ee="">
          <section className="mb-10">
            <div className="p-5 text-center bg-image"
              style={{
                backgroundImage: 'url(https://images.pexels.com/photos/57705/lake-evening-sunset-abendstimmung-57705.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)', height: '500px', backgroundSize: 'cover', backgroundPosition: '50% 50%', backgroundColor: 'rgba(0, 0, 0, 0)',
...
>>>>>>> a651ceb38575468bf07580e8ce71603c97a9da3a
